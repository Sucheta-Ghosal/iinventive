...
const dummyData = [
  ...
  },
  {
    ...
    description: "A low-latency tele-robotic arm that can be operated by surgeons remotely to perform life-saving surgeries in rural hospitals.",
  ...
  // Earth Sciences
  {
    ...
    submittedBy: "IIT(ISM) DHANBAD",
    description: "A network of autonomous quantum sensors predicting early seismic activities up to 10 seconds faster than conventional methods.",
  ...
  // Artificial Intelligence
  {
    ...
    submittedBy: "IIT PATNA",
    description: "An AI system utilizing decentralized edge devices to build massive, privacy-preserving corpora for Indian regional dialects.",
    longDescription: "India boasts hundreds of distinct regional languages and dialects that remain severely underrepresented in modern natural language processing models. Our platform solves this via Edge-Federated Learning. Instead of uploading vast amounts of sensitive audio to a central server, the AI models are trained locally on users' smartphones. Only the updated mathematical weights are securely synced back to the global model. This inherently preserves user privacy, massively reduces bandwidth costs in rural areas, and successfully builds highly accurate real-time speech-to-text and translation engines for dialects like Bhojpuri, Maithili, and Santhali, bridging the digital divide.",
    images: [
  ...
  // Semiconductor Technology & Chip Design
  {
    ...
    category: "Semiconductor Technology & Chip Design",
    submittedBy: "IIT BHUBANESWAR",
    description: "Custom silicon architecture targeting smart home devices that slashes power consumption by 60% compared to standard ARM cores.",
    longDescription: "As the Internet of Things (IoT) expands universally, power efficiency is paramount. Our team has engineered a fully custom, heavily optimized RISC-V instruction set architecture built from the ground up to minimize leakage current and dynamic power scaling. Utilizing a specialized 22nm FD-SOI fabrication node, the processor enters deep sleep states within microseconds and utilizes asynchronous logic gates to prevent clock tree power waste. Benchmarks verify a 60% reduction in battery consumption compared to modern Cortex-M equivalents, enabling smart home sensors and wearables to last years on a single coin-cell battery without sacrificing edge-compute performance.",
    images: [
...
const importData = async () => {
  try {
    ...
    console.log('Dummy Data Imported to MongoDB Successfully!');
    process.exit();
  } catch (error) {
